...
export const metadata: Metadata = {
  title: "Urban Collective - Premium Streetwear Fashion",
  description: "Shop authentic premium streetwear and limited edition urban fashion. Quality clothing designed for culture. Fast shipping, 30-day returns.",
  keywords: "streetwear, urban fashion, premium clothing, limited edition, street culture, urban style",
  metadataBase: new URL("https://urbancollective.com"),
  alternates: {
    canonical: "https://urbancollective.com"
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    title: "Urban Collective - Premium Streetwear",
    description: "Discover elevated urban fashion with authentic streetwear design",
    type: "website",
    siteName: "Urban Collective",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763759626190-r5ojnslk.jpg",
        alt: "Urban Collective Premium Streetwear"
      }
    ]
  },
  twitter: {
    ...
    title: "Urban Collective - Premium Streetwear",
    description: "Authentic urban fashion for culture enthusiasts",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763759626190-r5ojnslk.jpg"]
  }
};
